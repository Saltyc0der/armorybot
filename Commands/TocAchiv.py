...
class TocAchiv:
    ...
    async def buildEmbed(self):
        ...
        emb.add_field(name="Trial of the (Grand) Crusader 10", value=self.character.getTocAchiv("toc10"), inline=True)
        emb.add_field(name="Trial of the (Grand) Crusader 25", value=self.character.getTocAchiv("toc25"), inline=True)
