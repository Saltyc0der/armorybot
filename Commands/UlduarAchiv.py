...
class UldAchiv:
    ...
    async def buildEmbed(self):
        ...
        emb.add_field(name="Ulduar 10", value=self.character.getUlduarAchiv("uld10"), inline=True)
        emb.add_field(name="Ulduar 25", value=self.character.getUlduarAchiv("uld25"), inline=True)
