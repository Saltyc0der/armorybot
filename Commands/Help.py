...
class Help:
        ...
        async def Result(self):
            ...
            emb.add_field(name="", value="<> means required argument, [] means optional argument")
            ...
            emb.add_field(name="{prefix} setprefix <newprefix> [nospace]".format(prefix=self.prefix), value="Allows you to set a new prefix for your server.\n Optional [nospace] parameter allow you to set prefix without space\n For example: if you want to have commands use just ! so you can do !summary <name> y", inline=False)
