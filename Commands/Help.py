...
class Help:
        ...
        async def Result(self):
            ...
            emb.add_field(name="{prefix} icc | rs | toc | uld | naxx <name> [realm]".format(prefix=self.prefix), value="Gives list of specified instance achievments, current default realm for server is {realm}".format(realm = self.realm), inline=False)
            ...
            emb.set_footer(text='Hi! This is bot created by Edgy on Icecrown. You can message me at "edgy.at.linux" on discord')
            return emb