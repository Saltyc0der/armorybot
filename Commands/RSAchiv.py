...
class RSAchiv:
    ...
    async def buildEmbed(self):
        ...
        emb.add_field(name="Ruby Sanctum 10", value=self.character.getRSAchiv("naxx10"), inline=True)
        emb.add_field(name="Ruby Sanctum 25", value=self.character.getRSAchiv("naxx25"), inline=True)
